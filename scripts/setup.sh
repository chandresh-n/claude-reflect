...
ok "Setup complete."
echo ""
info "Quick start (standalone CLI):"
...
echo ""
info "Quick start (Claude Code plugin):"
echo "  From Claude Code: /plugin install $(cd "$PROJECT_ROOT" && pwd)"
echo "  Then: /claude-reflect:review last 7 days"
echo ""
